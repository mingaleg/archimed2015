...
<body>
<?php
//    die("Team logins are not distributed by regions yet.<br/>If you see this message in the contest day, then something goes really bad.<br/>Please contact contest administrator: oleg@mingalev.net / +7(925)79-25-154 (Oleg Igorevich Mingalev)");
    $regid = $_GET['id'];
